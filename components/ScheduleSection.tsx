      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-center text-[#B8860B]">Pawiwahan</h3>
            <br />
            <div className="text-center space-y-4 mt-4">
              <Calendar className="w-8 h-8 text-[#B8860B] mx-auto" />
              <h3 className="text-xl font-serif">Rahina Soma</h3>
              <p className="text-lg">31 Maret 2025</p>
            </div>
            <div className="text-center space-y-4 mt-4">
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-center text-[#B8860B]">Resepsi</h3>
            <br />
            <div className="text-center space-y-4 mt-4">
              <Calendar className="w-8 h-8 text-[#B8860B] mx-auto" />
              <h3 className="text-xl font-serif">Rahina Soma</h3>
            ...
            <div className="text-center space-y-4 mt-4">
              <Clock className="w-8 h-8 text-[#B8860B] mx-auto" />
              <p className="text-lg">Pukul 18:00 - 23:00 WITA</p>
            </div>
            <div className="mt-8 text-center space-y-4">
              <MapPin className="w-8 h-8 text-[#B8860B] mx-auto" />
              <h3 className="text-xl font-serif">Bertempat di</h3>
